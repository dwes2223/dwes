<nav class="navbar navbar-expand-md navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo isset($_SESSION['user']) ? PATH."/productType":"" ?>">
        <?php echo isset($_SESSION['user']) ? "Tipos de Productos":""?></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo isset($_SESSION['user']) ? PATH."/basket":"" ?>">
        <?php echo isset($_SESSION['user']) ? "Cesta":""?></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo isset($_SESSION['user']) ? PATH."/order":"" ?>">
        <?php echo isset($_SESSION['user']) ? "Pedidos":""?></a>
      </li>
      </ul>
